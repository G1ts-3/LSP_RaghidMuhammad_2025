        ...
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('class') is-invalid @enderror" id="class" name="class">
                    ...
                    <option value="10" {{ old('class') == '10' ? 'selected' : '' }}>Kelas 10</option>
                    <option value="11" {{ old('class') == '11' ? 'selected' : '' }}>Kelas 11</option>
                    <option value="12" {{ old('class') == '12' ? 'selected' : '' }}>Kelas 12</option>
                </select>
                @error('class')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('major') is-invalid @enderror" id="major" name="major">
                    ...
                    <option value="TJA" {{ old('major') == 'TJA' ? 'selected' : '' }}>TJA</option>
                    <option value="Transmisi" {{ old('major') == 'Transmisi' ? 'selected' : '' }}>Transmisi</option>
                </select>
                @error('major')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
